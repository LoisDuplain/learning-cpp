...
void	ClapTrap::takeDamage(unsigned int amount)
{
	...
	std::cout << "ClapTrap <" << _name << "> Now I have " << _energy_points << " energy points" << std::endl;
}
void	ClapTrap::beRepaired(unsigned int amount)
{
	std::cout << "ClapTrap <" << _name << "> I've been repaired with " << amount << " energy points" << std::endl;
	
	unsigned long value = (unsigned long)_energy_points + amount;
	if (value > UINT_MAX)
		_energy_points = UINT_MAX;
	else
